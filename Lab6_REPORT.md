...
![Результат задания 1](png/Lab6_1.png)
...
![Результат задания 2](png/Lab6_2.png)
...
![Результат задания 3](png/Lab6_3.png)

## Выводы

1. Сначала из введённой строки создаю словарь
2. Затем словарь конвертирую в список, чтобы можно было отсортировать по самым частовведённым числам
3. Затем из отсортированного списка беру первые три значения
4. Эти три значения сортирую по ключу
5. Создаю из списка упорядоченный словарь
...
![Результат задания 4](png/Lab6_4.png)
...
![Результат задания 5](png/Lab6_5.png)
